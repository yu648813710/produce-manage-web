const columns = [
  ...
  { title: '保质期', dataIndex: 'expiryTime', key: 'expiryTime' },
  { title: '木耳图片', scopedSlots: { customRender: 'productPicture' }, key: 'productPicture' },
  { title: '溯源二维码', scopedSlots: { customRender: 'qrcodeId' }, key: 'qrcodeId' },
