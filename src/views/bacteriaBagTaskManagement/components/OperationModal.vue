  ...
  <div>
     <a-modal
      ...
      <div class="detail-wrapper">
        <a-row class="row-style" type="flex" justify="center">
          <a-col>
        ...
        <a-row class="row-style" type="flex" justify="center">
          <a-col>
            ...
            <span class="item-value">{{commonData.extendData.finishTime ? commonData.extendData.finishTime : ''}}</span>
          </a-col>
        </a-row>
        <a-row class="row-style" type="flex" justify="center">
          <a-col>
        ...
        <div v-if="commonData.actionId === 'J010'">
          <a-row class="row-style" type="flex" justify="center" >
            <a-col>
              ...
              <span class="item-value">{{commonData.extendData.deliveryTime ? commonData.extendData.deliveryTime : ''}}</span>
            </a-col>
          </a-row>
          <a-row class="row-style" type="flex" justify="center">
            <a-col>
              <span class="item-key">出库数量：</span>
              <span class="item-value">{{commonData.extendData.amount ? commonData.extendData.amount : ''}}</span>
            </a-col>
          </a-row>
          <a-row class="row-style" type="flex" justify="center">
            <a-col>
              <span class="item-key">出库人：</span>
              <span class="item-value">{{commonData.extendData.userName ? commonData.extendData.userName : ''}}</span>
            </a-col>
          </a-row>
          <a-row class="row-style" type="flex" justify="center">
            <a-col>
              ...
              <span class="item-value">
                {{commonData.extendData.specification.high}}*{{commonData.extendData.specification.diameter}}
              </span>
            </a-col>
          </a-row>
        </div>
        ...
        <div v-if="commonData.actionId === 'J008'">
          <a-row class="row-style" type="flex" justify="center" >
            <a-col>
              ...
              <span class="item-value">{{commonData.extendData.verifyTime ? commonData.extendData.verifyTime : ''}}</span>
            </a-col>
          </a-row>
          <a-row class="row-style" type="flex" justify="center">
            <a-col>
          ...
          <a-row class="row-style" type="flex" justify="center">
            <a-col>
              ...
              <span class="item-value">{{commonData.extendData.verifyOrganization ? commonData.extendData.verifyOrganization : ''}}</span>
            </a-col>
          </a-row>
          <a-row class="row-style" type="flex" justify="center">
            <a-col>
              <span class="item-key">检验结果：</span>
              <span class="item-value">{{commonData.extendData.vefiyResult ? commonData.extendData.vefiyResult : ''}}</span>
            </a-col>
          </a-row>
        </div>
        <!-- 其他 -->
