        ...
        <div class="warrningBox">
          ...
          <div class="warringIMG">
            <div class="imgContent">
              <div class="warring1" @click="warringDetailList(2)">
                <router-link
                  :to="{name: 'massifDetail'}"
                ></router-link>
                <div>
                  新增{{warring1}}条预警
                </div>
              ...
              <div class="warring2" @click="warringDetailList(1)">
                <div>
                  新增{{warring2}}条预警
                </div>
                <div>
    ...
    <a-row>
      <div class="warringStaticContent">
        <div class="staticEchart">
          ...
          <div class="echartsContent" id="pieEcharts"></div>
        </div>
        <div class="staticEchart">
    ...
    export default {
        ...
        methods: {
                ...
                this.myChart.setOption({
                    ...
                    series: [{
                        ...
                        color:function(params){
                            ...
                            let colorList = ['#02FBF8','#FFC100','#6A79F6','#F7A95D','#F7DB6B'];
                            console.log(params)
            ...
            warringDetailList(index){
                if(index === 1){
                    this.$router.push({ path: `/Production/warringList/${index}`})
                }else if(index === 2){
                    this.$router.push({ path: `/Production/warringList/${index}`})
                }
            },
