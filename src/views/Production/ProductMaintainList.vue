<template>
  <div class="product_maintain">
    ...
    <div class="form">
      ...
      <a-form class="searchForm">
        <a-row :gutter="24" type="flex" justify="center">
          <!--          &lt;!&ndash; 基地名称 &ndash;&gt;-->
          <a-col :span="8">
            <a-form-item label="基地名称:" :label-col="{ span: 24 }" :wrapper-col="{ span: 24 }">
    ...
    <a-modal title="新增基地" v-model="visible" @ok="handleOk">
      <div class="form">
        <a-form :form="form" @submit="handleSubmit">
          ...
          <a-row :gutter="40">
            <a-col :span="24">
              <a-form-item label="基地电话:" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }">
                <a-input
                  autocomplete="off"
                  placeholder="请输入基地电话"
                  v-decorator="['phone',{rules: [{ required: true, message: '请输入基地电话!' }]}]"
                />
              </a-form-item>
            </a-col>
            <a-col :span="24">
